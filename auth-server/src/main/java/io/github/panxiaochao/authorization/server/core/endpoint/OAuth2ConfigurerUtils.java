...
public class OAuth2ConfigurerUtils {
	...
	public static AuthenticationManager getAuthenticationManager(HttpSecurity httpSecurity) {
		...
		if (authenticationManager == null) {
			authenticationManager = getOptionalBean(httpSecurity, AuthenticationManager.class);
			httpSecurity.setSharedObject(AuthenticationManager.class, authenticationManager);
		}
